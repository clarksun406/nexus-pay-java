...
public class ConnectorService {
    ...
    public ProviderAccount create(UUID merchantId, CreateConnectorRequest req) {
        ...
        account.setEncryptedSecretKey(encryptionService.encrypt(req.encryptedSecretKey()));
        account.setEncryptedPublishableKey(encryptionService.encrypt(req.encryptedPublishableKey()));
